...
define( 'CATORA_SERVICE_VISIBILITY_VERSION', '0.2.3' );
define( 'CATORA_SERVICE_VISIBILITY_FILE', __FILE__ );
define( 'CATORA_SERVICE_VISIBILITY_DIR', plugin_dir_path( __FILE__ ) );

require_once CATORA_SERVICE_VISIBILITY_DIR . 'includes/php-compatibility.php';
require_once CATORA_SERVICE_VISIBILITY_DIR . 'includes/class-catora-service-visibility.php';
require_once CATORA_SERVICE_VISIBILITY_DIR . 'includes/class-catora-service-visibility-auto-rescan.php';
...
register_deactivation_hook( __FILE__, array( 'Catora_Service_Visibility_Auto_Rescan', 'deactivate' ) );

Catora_Service_Visibility::instance();
Catora_Service_Visibility_Auto_Rescan::instance();
