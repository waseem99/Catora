"""add authentication sessions, invitations and password reset tokens
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "role IN ('owner','admin','analyst','reviewer','viewer')",
            name="ck_invitations_valid_role",
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("token_hash"),
        sa.UniqueConstraint("workspace_id", "email", "token_hash"),
    )
